...
var ErrUncnownEventType = errors.New("uncnown event type")
var ErrUncnownMetaType = errors.New("uncnown meta type")
...
func meta(event events.Event) (Meta, error) {
	...
	if !ok {
		return Meta{}, e.Wrap("can't get meta", ErrUncnownMetaType)
	}
